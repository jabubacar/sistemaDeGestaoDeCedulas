    ...
    <section>
        <ul>
            ...
            <li class="ga">
                ...
                <div id="nomeA"> Jozino Momade Zeii</div>
                
                <div id="editar"><a href="editar2.jsp">editar</a></div>

                <div id="eliminar"><a href=""> eliminar </a></div>

                <div id="imprimir" ><a href="documentos/CEDULA PESSOAL.pdf">imprimir </a></div>
            </li>
        ...
        <li class="ga">
            ...
            <div id="imprimir"><a>imprimir </a></div>
        </li>
        <li>
            ...
            <div id="editar"><a href="">editar</a></div>
